...
namespace AdminSERMAC.Forms
{
    ...
    bool esTraspasoCongelados)
        {
            string ubicacionOrigen = esOrigenCongelados ? "Cámara Congelados" : "Inventario Normal";
            string ubicacionDestino = esTraspasoCongelados ?
                (esOrigenCongelados ? "Inventario Normal" : "Cámara Congelados") :
                "Local";

            var command = new SQLiteCommand(@"
        INSERT INTO HistorialTraspasos (
            FechaTraspaso, UbicacionOrigen, UbicacionDestino, 
            ...
            command.Parameters.AddWithValue("@fechaTraspaso", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
            command.Parameters.AddWithValue("@ubicacionOrigen", ubicacionOrigen);
            command.Parameters.AddWithValue("@ubicacionDestino", ubicacionDestino);
